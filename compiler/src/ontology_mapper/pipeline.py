...
Usage:
    ...
    State is stored per-run: .compiler-runs/{run_id}/.compiler-state.json
"""
...
class PipelineState:
    ...
    def new(cls, organization: str = "") -> "PipelineState":
        ...
        # When SEMANTIC_COMPILER_RUNS_DIR is set (e.g., web UI org-scoped dirs),
        # the org is already the parent directory — no prefix needed.
        if organization and not os.environ.get("SEMANTIC_COMPILER_RUNS_DIR"):
