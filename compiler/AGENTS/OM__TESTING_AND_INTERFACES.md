...
|----------|---------|---------|
| `SEMANTIC_COMPILER_SPECS_DIR` | Path to reference catalogs, vector indexes, and embedding model | `{package}/specs/` |
| `SEMANTIC_COMPILER_RUNS_DIR` | Path to pipeline run directories | `.compiler-runs/` (CWD-relative) |
