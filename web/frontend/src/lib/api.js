/**
 * API client with Clerk JWT authentication.
 *
 * All calls include the Authorization header automatically.
 */
...
async function fetchAPI(path, options = {}, _retry = true) {
  ...
  // Retry once on 401 — Clerk token may not be ready on first call
