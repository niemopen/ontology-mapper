...
pipeline stage.  Domain-agnostic — derives all paths from .compiler-state.json.
...
def _load_state(run_dir):
    """Load .compiler-state.json, returning empty dict on failure."""
    return _load_json(run_dir / ".compiler-state.json") or {}
