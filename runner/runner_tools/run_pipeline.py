...
def load_state(run_dir: Path) -> dict:
    """Load .compiler-state.json from a run directory."""
    state_path = run_dir / ".compiler-state.json"
...
Stage 5 of a semantic compiler pipeline. The reviewer is looking at a mapping
