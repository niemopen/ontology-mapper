...
> **Repo**: OntologyMapperRunner | **Version**: 3.0 | **Updated**: 2026-04-04
...
### Orchestration Config (`.compiler-state.json`)

Run-level orchestration parameters are stored in the `orchestrationConfig`
object within `.compiler-state.json` (via `PipelineState.orchestration_config`).
